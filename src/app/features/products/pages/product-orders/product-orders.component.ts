...
import { Order, OrderStatus } from '../../../../services/models/order.model';
...
export class ProductOrdersComponent {
  refreshOrders() {
    ...
    this.orderService.getOrdersByShop(currentShopId!, this.startDate, this.endDate).subscribe({
      next: (orders) => {
        this.orders = orders;
  ...
  orders: Order[] = [
    ...
    { id: 'ORD-003', channel: 'Online',    customer: { name: 'Clara Dunn',     email: 'clara@email.com'   }, itemCount: 3, total: 9000,  paymentStatus: 'paid',    status: 'in progress', date: '2026-02-21' },
    ...
    { id: 'ORD-008', channel: 'Online',    customer: { name: 'Henry Dubois',   email: 'henry@email.com'   }, itemCount: 2, total: 7500,  paymentStatus: 'paid',    status: 'in progress', date: '2026-02-20' },
    ...
    { id: 'ORD-013', channel: 'Online',    customer: { name: 'Mia Thompson',   email: 'mia@email.com'     }, itemCount: 1, total: 3000,  paymentStatus: 'paid',    status: 'in progress', date: '2026-02-21' },
    ...
    { id: 'ORD-017', channel: 'Online',    customer: { name: 'Quinn Adams',    email: 'quinn@email.com'   }, itemCount: 4, total: 11200, paymentStatus: 'paid',    status: 'in progress', date: '2026-02-20' },
    ...
    { id: 'ORD-021', channel: 'In-store',  customer: { name: 'Umar Hassan',    email: 'umar@email.com'    }, itemCount: 2, total: 6100,  paymentStatus: 'paid',    status: 'in progress', date: '2026-02-21' },
  ...
  ngOnInit() {
    // In a real app, you'd fetch orders from the server here
    this.refreshOrders()
  }
}
